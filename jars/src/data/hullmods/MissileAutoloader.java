...
public class MissileAutoloader extends BaseHullMod {
	...
	static {
		...
		CAPACITY_DATA.add(new ReloadCapacityData(HullSize.DESTROYER, 1, 2, 9));
		CAPACITY_DATA.add(new ReloadCapacityData(HullSize.DESTROYER, 3, -1, 4));
		
		CAPACITY_DATA.add(new ReloadCapacityData(HullSize.CRUISER, 1, 3, 15));
		CAPACITY_DATA.add(new ReloadCapacityData(HullSize.CRUISER, 4, 5, 12));
		CAPACITY_DATA.add(new ReloadCapacityData(HullSize.CRUISER, 6, -1, 8));
		
		CAPACITY_DATA.add(new ReloadCapacityData(HullSize.CAPITAL_SHIP, 1, 4, 24));
		CAPACITY_DATA.add(new ReloadCapacityData(HullSize.CAPITAL_SHIP, 5, 6, 18));
